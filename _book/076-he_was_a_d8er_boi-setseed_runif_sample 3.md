...
```r
runif(n = 3)
#> [1] 0.467657016 0.002901192 0.168001428
```
...
```r
rnorm(n = 5, sd = 2)
#> [1] -2.7724567 -1.3110072  0.3321453  2.2933708 -1.4207831
```
...
#> [1] 12.806760  9.668042  8.972661  9.790245 14.258464
```
