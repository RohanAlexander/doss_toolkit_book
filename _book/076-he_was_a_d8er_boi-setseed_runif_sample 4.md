...
```r
runif(n = 3)
#> [1] 0.38739213 0.44400712 0.09936123
```
...
```r
rnorm(n = 5, sd = 2)
#> [1] -1.37045578 -1.28230541 -0.04021313 -0.28644077
#> [5]  0.95854864
```
...
#> [1]  6.636559  7.506789 12.033818  7.273518 10.850091
```
