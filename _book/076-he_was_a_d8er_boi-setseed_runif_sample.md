...
```r
runif(n = 3)
#> [1] 0.4175356 0.2519035 0.4627664
```
...
```r
rnorm(n = 5, sd = 2)
#> [1] -1.9902593  0.2296143  1.0891829 -4.7281384  3.4301111
```
...
#> [1] 10.829548  8.397596 11.507572  9.452923  7.636338
```
