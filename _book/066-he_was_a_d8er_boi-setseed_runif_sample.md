...
```r
runif(n = 3)
#> [1] 0.3136464 0.7933519 0.4009962
```
...
```r
rnorm(n = 5, sd = 2)
#> [1]  5.082115  3.689435 -1.669991  2.001274 -1.547801
```
...
#> [1] 11.083219 12.490950  9.465004 12.333554  7.775903
```
