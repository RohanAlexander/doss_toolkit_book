...
```r
runif(n = 3)
#> [1] 0.8277382 0.9342846 0.8822647
```
...
```r
rnorm(n = 5, sd = 2)
#> [1]  0.5914366 -1.0349263 -1.4295918 -1.2005076 -0.1495343
```
...
#> [1] 11.364727 13.890682 12.804414  4.429925 10.426368
```
