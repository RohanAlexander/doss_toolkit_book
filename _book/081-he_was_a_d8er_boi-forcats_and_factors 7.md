...
#>  [1] "Lack (or loss) of supplies or equipment"                                     
#>  [2] "Lack of time"                                                                
...
#>  [8] "Route technically too difficult, lack of experience, strength, or motivation"
#>  [9] "Did not attempt climb"                                                       
#> [10] "Illness, AMS, exhaustion, or frostbite"                                      
#> [11] "Success (claimed)"                                                           
#> [12] "Unknown"                                                                     
#> [13] "Attempt rumoured"                                                            
#> [14] "Bad weather (storms, high winds)"                                            
#> [15] "Success (main peak)"
```
...
#> [746] Germany   Spain    
#> 8 Levels: Italy Germany Australia France Brazil ... Mexico
```
