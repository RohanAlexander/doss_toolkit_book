...
```r
runif(n = 3)
#> [1] 0.1510206 0.4866018 0.7067751
```
...
```r
rnorm(n = 5, sd = 2)
#> [1] -1.1767548 -1.9309134  1.4333831  2.2163540 -0.3692445
```
...
#> [1] 13.165978  9.404728  9.508224 11.095400  9.275065
```
