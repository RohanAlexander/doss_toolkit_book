...
#>  [1] "Route technically too difficult, lack of experience, strength, or motivation"
#>  [2] "Unknown"                                                                     
#>  [3] "Lack (or loss) of supplies or equipment"                                     
#>  [4] "Bad conditions (deep snow, avalanching, falling ice, or rock)"               
#>  [5] "Success (claimed)"                                                           
#>  [6] "Did not attempt climb"                                                       
#>  [7] "Did not reach base camp"                                                     
#>  [8] "Success (main peak)"                                                         
#>  [9] "Attempt rumoured"                                                            
#> [10] "Other"                                                                       
#> [11] "Success (subpeak)"                                                           
#> [12] "Lack of time"                                                                
#> [13] "Illness, AMS, exhaustion, or frostbite"                                      
...
#> [746] Germany   Spain    
#> 8 Levels: Spain France Brazil Italy Canada ... Mexico
```
