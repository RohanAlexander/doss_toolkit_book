...
```r
runif(n = 3)
#> [1] 0.5628267 0.4070257 0.7375785
```
...
```r
rnorm(n = 5, sd = 2)
#> [1]  1.9949095 -2.5026499  0.4004735  0.3627964 -1.2885863
```
...
#> [1]  8.917192 10.376547  8.575403 10.842811  9.541274
```
