...
```{r wider-first-example, echo=TRUE}
...
```{r games1ref, echo=FALSE}
games[games=="l"] <- NA
games
```
```{r games2ref, echo = FALSE}
games2 <- pivot_longer(data = games, cols = c(gm1, gm2, gm3, gm4, gm5), values_drop_na = TRUE)
games2
```
