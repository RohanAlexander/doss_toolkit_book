...
We can perform sentiment analysis using inner join with tidy text data format. 
...
<!--           answer("ords like "the", "on" that are very common in natural language and may not be useful for text analysis", correct = TRUE), -->
