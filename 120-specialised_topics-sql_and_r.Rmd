...
*Written by Yena Joo and last updated on DATE 2021.*
...
### Question 3
3. If I want to delete an entire table, which function would I use (pick one)? 
  a. `dbSendQuery()`  
  b. `dbDeleteTable()`  
  c. `dbRemoveTable()`  
  d. `dbRemoveDB()` 
...
### Question 4
4. What query should I write if I want to view the data?   
