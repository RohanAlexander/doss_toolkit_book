...
knitr::include_graphics(here::here("images", "106_distill_3.png"))
```
...
knitr::include_graphics(here::here("images", "106_distill_5.gif"))
...
```{r, echo=FALSE, out.width="100%", fig.align = "center"}
knitr::include_graphics(here::here("images", "106_distill_7.gif"))
```
