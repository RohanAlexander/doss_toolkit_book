...
106L, 107L, 108L, 109L, 110L, 111L, 112L, 113L, 114L, 115L), 
    ...
    0L, 1L, 1L, 0L, 0L, 0L, 0L, 0L)), .Names = c("Days", "Students"), class = "data.frame", row.names = c(NA, -109L))
attach(cases)

```

Fit the glm by specifying the poisson distribution and including it in the argument. Display model results by using `summary()`.
