...
*Written by Yena Joo and last updated on February 2022.*
...
### Question 8
(True or False) If you want to change the unit of the measurement, simply put "cm" at the end of either `width` or `height` arguments like the following chunk of code:  
```
ggsave("example.pdf", width = 20cm, height = 20cm)
```  
a. True  
b. False  

### Question 9
(True or False) Setting path of the directory when saving graph is not necessary, because by default, it is directed to the working directory.  
a. True  
b. False  

### Question 10
Which file format can `ggsave()` save into (Select all that apply)?  
a. jpeg  
b. pdf  
c. docx  
d. csv  
