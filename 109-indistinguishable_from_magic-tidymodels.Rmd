...
There are two big modes of the model, classification and regression. To briefly explain, classification predicst discrete class labels, whereas regression predicts a continuous quantity output.  
